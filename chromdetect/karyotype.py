...
KARYOTYPE_DATABASE: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "notes": "Commonly reported as 2n=48",
    },
    {
        "name": "fugu",
        ...
        "notes": "Commonly reported as 2n=44",
    },
    {
        ...
        "sex_chromosomes": [],
        "sex_system": "unknown",
        "aliases": ["atlantic salmon", "s. salar", "ssalar"],
        "notes": "Commonly reported as 2n=58",
    },
    {
        "name": "rainbow_trout",
        ...
        "sex_chromosomes": [],
        "sex_system": "unknown",
        "aliases": ["rainbow trout", "o. mykiss", "omykiss"],
        "notes": "Commonly reported as 2n=58-64; assembly counts may vary",
    },
    {
        "name": "tilapia",
        ...
        "sex_chromosomes": [],
        "sex_system": "unknown",
        "aliases": ["nile tilapia", "o. niloticus", "oniloticus"],
        "notes": "Commonly reported as 2n=44",
    },
    {
        "name": "common_carp",
        ...
        "taxid": 7962,
        "chromosome_count": 50,
        "autosomes": [str(i) for i in range(1, 51)],
        "sex_chromosomes": [],
        "sex_system": "unknown",
        "aliases": ["common carp", "carp", "c. carpio", "ccarpio"],
        "notes": "Commonly reported as 2n=100",
    },
    {
        "name": "stickleback",
        ...
        "taxid": 69293,
        "chromosome_count": 21,
        "autosomes": [str(i) for i in range(1, 22)],
        "sex_chromosomes": [],
        "sex_system": "unknown",
        "aliases": [
        ...
        "notes": "Commonly reported as 2n=42",
    },
    # Amphibians
    {
        "name": "xenopus",
